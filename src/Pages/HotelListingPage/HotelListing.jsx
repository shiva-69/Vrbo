    ...
    return (
        <div className={HotelListingStyles.mainContainer}>
            <div className={HotelListingStyles.resultsContainer}>
                ...
                {  hotels.map((item)=>
                (<>
                    <div className={HotelListingStyles.hoteldiv}>
